 ...
 * Compile a template.
 */
function compile$2(template, options) {
...
function transformNode(el, options) {
  ...
  var dynamic = _parseStaticClass.dynamic;
  var classResult = _parseStaticClass.classResult;
...
function transformNode$1(el, options) {
  ...
  var dynamic = _parseStaticStyle.dynamic;
  var styleResult = _parseStaticStyle.styleResult;
...
function parse$1(el, options) {
  var staticStyle = getAndRemoveAttr(el, 'append');
  if (staticStyle === 'tree') {
    el.atom = true;
  }
}
...
var modules = [klass, style, append];
