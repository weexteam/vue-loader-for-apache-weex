...
Node.prototype.setAttribute = function setAttribute(key, value) {
  ...
  if (this.attached) {
    global.callNative(this.instanceId, [{ module: 'dom', method: 'updateAttrs', args: [String(this.nodeId), babelHelpers.defineProperty({}, key, value)] }]);
  }
};
...
Node.prototype.removeAttribute = function setAttribute(key) {
  ...
  delete this.attr[key];
  if (this.attached) {
    global.callNative(this.instanceId, [{ module: 'dom', method: 'updateAttr', args: [String(this.nodeId), babelHelpers.defineProperty({}, key, null)] }]);
  }
};
...
Node.prototype.setStyle = function setStyle(key, value) {
  ...
  if (this.attached) {
    global.callNative(this.instanceId, [{ module: 'dom', method: 'updateStyle', args: [String(this.nodeId), babelHelpers.defineProperty({}, key, value)] }]);
  }
};
...
var isReservedTag$1 = makeMap('div,img,image,input,switch,indicator,list,scroller,cell,template,text,slider,image');
